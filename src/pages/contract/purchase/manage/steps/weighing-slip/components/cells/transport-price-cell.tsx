...
const TransportPriceCell = ({ index }: IndexProps) => {
  ...
  return (
    <ActualTowingCell index={index}>
      <Field.Number name={getActualTowingPropertyName('transportPrice', index)} placeholder="Đơn Giá Vận Tải" readOnly={saved} />
    </ActualTowingCell>
  );
};

export default TransportPriceCell;
