...
export default function AlertShippingUnitActivate({ id, title, open, handleClose, onActivateSuccess }: Props) {
  const { activate } = useShippingUnit();
      ...
      <DialogContent>
        <DialogContentText sx={{ mb: 2 }}>
          <Typography variant="h6" sx={{ mb: 2, fontWeight: 600, color: 'text.primary' }}>
            Bạn có chắc chắn muốn kích hoạt đơn vị vận chuyển{' '}
